package io.github.eylexlive.leaderboards.util.inventory;
...
public class InventoryUI {
    ...
    private void createNewInventory() {
        ...
        if (this.inventories.size() > 0) {
            inventory.setItem(0, this.rows - 1, new AbstractClickableItem(ItemUtil.createItem(Material.ARROW,   "§eSayfa #" + this.inventories.size())) {
                @Override
    ...
    public void addItem(final ClickableItem item) {
        ...
        if (lastInventory.currentY == this.rows - 1 && lastInventory.currentX >= 7 - this.offset) {
            lastInventory.setItem(8, this.rows - 1, new AbstractClickableItem(ItemUtil.createItem(Material.ARROW,   "§6Sayfa #" + (this.inventories.size() + 1))) {
                @Override
                public void onClick(final InventoryClickEvent event) {
                    InventoryUI.this.page++;
                    try {
