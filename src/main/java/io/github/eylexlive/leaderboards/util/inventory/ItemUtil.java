...
public class ItemUtil {
    ...
    public static ItemStack createItem(Material material, final String otherName, final String name, final int amount, final short damage) {
        if (material == null)
            material = Material.matchMaterial(otherName);
